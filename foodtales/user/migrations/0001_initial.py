    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restaurant_id', models.CharField(blank=True, max_length=50, null=True, unique=True)),
            ...
            options={
                'constraints': [models.UniqueConstraint(condition=models.Q(('user_type', 'employee')), fields=('employee_id',), name='unique_employee_id'), models.UniqueConstraint(condition=models.Q(('user_type', 'restaurant')), fields=('restaurant_id',), name='unique_restaurant_id')],
            },
        ),
    ]
